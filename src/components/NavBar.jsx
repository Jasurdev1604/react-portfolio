...
export const NavBar = () =>{
    ...
    useEffect(() => {
        const onScroll = () =>{
            if(window.scrollY > 50)seScrolled(true);
                ...
                <Navbar.Toggle aria-controle="basic-navbar-nav">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            <Nav.Link href="#projects"className={activeLink === 'home' ? 'active navbar-link':'navbar-link'}onClick={()=>onUpdateActiveLink('prijects')} >Projects</Nav.Link>
                        </Nav>
